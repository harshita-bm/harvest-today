...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('assets/loginpage_assets/images/retaier_shop.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form autocomplete="off" class="login100-form validate-form p-b-33 p-t-5" action="controller\reg&login_controller.php" method="POST" autocomplete="off">
					...
					<h2 style="text-align: center; font-family: Ubuntu-Regular;"><a style="color:black;"  href="reg_front.php">Don't have an account? Create</a></h2>
				</form>
