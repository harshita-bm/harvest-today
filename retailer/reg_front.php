		...
		<div class="wrapper wrapper--w790">
			<div class="card card-5">
				<div class="card-heading">
					<h2 class="title">Retailer Registration</h2>
				</div>
				<div class="card-body">
					<form autocomplete="off" action="controller\reg&login_controller.php" method="POST" enctype="multipart/form-data">
						...
						<!-- doctor name -->
						<div class="form-row">
							<div class="name">Retailer Name</div>
							<div class="value">
								<div class="input-group">
									<input class="input--style-5" type="text" name="retailer_name" placeholder="Retailer name" required pattern="[a-zA-Z'-'\s]*" title="No numbers or special characters are allowed">
								</div>
							</div>
						</div>
						...
						<div class="form-row">
							...
							<div class="value">
								<div class="input-group">
									<input class="input--style-5" type="text" name="shop_name" placeholder="Shop name" required>
								</div>
							</div>
						</div>
						...
						<div class="form-row p-t-20">
							<label class="label label--block">Are you an existing Retailer?<a href="login_front.php">Login here</a></label>
						</div>
						<div>
