  ...
  <!--  # navbar / header -->
    ...
    <!--  #  sidebar   # -->
      ...
      <div class="main-panel"> <!--3. main panel starts-->
        <div class="content-wrapper" style="background-image: url('admindashboard.jpg');   background-size: 1305px auto;  background-repeat: no-repeat;"> <!-- 4. content wrapper starts-->
