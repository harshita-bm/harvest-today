        ...
        <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="admin_controller\category_controller.php" autocomplete="off" enctype="multipart/form-data">
                    
                  <div class="form-group row">
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Category Name</label>
                      <div class="col-sm-9">
                        <input type="text" name="category_name" class="form-control" id="exampleInputUsername2" placeholder="Category name" required>
                      </div>
                    </div>
 
                    <button type="submit" name="create_category" class="btn btn-primary mr-2">Submit</button>
