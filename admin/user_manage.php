                ...
                <?php  $query=$admin->ret("SELECT * FROM `user` ");
                    while($row=$query->fetch(PDO::FETCH_ASSOC) ) { ?>
                        <tr>
                          ...
                          <td><a type="button" class="btn btn-danger btn-rounded btn-fw" href="admin_controller\user_controller.php?remove_user=<?php echo $row['user_id'] ?>" onclick="return confirm('Are you sure you want to remove?');">Remove</a></td>
                        </tr>
                    <?php } ?>
                    <!--table data ends-->
                      </tbody>
