                ...
                <div class="card-body">
                  ...
                  <form action="admin_controller\blog_controller.php" method="POST" class="forms-sample" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="blog_heading" class="form-control" id="exampleInputName1" placeholder="Blog Heading" required>
                    </div>
         
                    <div class="form-group">
                      <label for="exampleTextarea1">Blog Content</label>
                      <textarea name="blog_content" class="form-control" id="exampleTextarea1" rows="4" placeholder="write blog..." required></textarea>
                    </div>
                    ...
                    <input type="submit" name="create_blog" value="Submit" class="btn btn-primary mr-2">
