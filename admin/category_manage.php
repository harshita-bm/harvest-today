                    ...
                    <tbody>
                      ...
                      while ($row = $query->fetch(PDO::FETCH_ASSOC)) { ?>
                        <tr>
                          ...
                          <td><a type="button" class="btn btn-info btn-rounded btn-fw" href="category_update.php?update_category=<?php echo $row['category_id'] ?>">Update</a></td>
                          <td><a type="button" class="btn btn-danger btn-rounded btn-fw" href="admin_controller\category_controller.php?delete_category=<?php echo $row['category_id'] ?>" onclick="return confirm('Are you sure you want to delete?');">Delete</a></td>
                        </tr>
                      <?php } ?>
                      <!--table data ends-->
                    </tbody>
