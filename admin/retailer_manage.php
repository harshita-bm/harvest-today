                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <!--table data starts -->
                <?php  $query=$admin->ret("SELECT * FROM `retailer` ");
                    while($row=$query->fetch(PDO::FETCH_ASSOC) ) { ?>
                        <tr>
    
                            <td><img src="../retailer/uploads/<?php echo $row['retailer_imagedb'] ?>" height="800px" width="800px"></td>
                          ...
                          <td><a type="button" class="btn btn-danger btn-rounded btn-fw" href="admin_controller\retailer_controller.php?remove_retailer=<?php echo $row['retailer_id'] ?>" onclick="return confirm('Are you sure you want to remove?');">Remove</a></td>
                        </tr>
                    <?php } ?>
                    <!--table data ends-->
                      </tbody>
