                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      ...
                      <!--table data starts -->
                <?php  $query=$admin->ret("SELECT * FROM `admin` where `admin_id`=".$s_variable);
                    while($row=$query->fetch(PDO::FETCH_ASSOC) ) { ?>
                        <tr>
                          <td><?php echo $row['username']?></td>
                          <td><?php echo $row['password']?></td>

                          <td><a type="button" class="btn btn-info btn-rounded btn-fw" href="account_update.php?update_account=<?php echo $row['admin_id'] ?>">Update</a></td>
                         </tr>
                    <?php } ?>
                    <!--table data ends-->
                      </tbody>
