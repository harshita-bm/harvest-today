			...
			<div class="card card-5">
				...
				<div class="card-body">
					<form autocomplete="off" action="controller\reg&login_controller.php" method="POST" enctype="multipart/form-data">
						...
						<!-- doctor name -->
						<div class="form-row">
							<div class="name">User Full Name</div>
							<div class="value">
								<div class="input-group">
									<input class="input--style-5"type="text" name="user_name" placeholder="User Full name" required pattern="[a-zA-Z'-'\s]*" title="No numbers or special characters are allowed">
								</div>
							</div>
						</div>
